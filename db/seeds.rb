...
Course.create(course_type:'Pilot Courses', info:'General subject ground e-learning courses for pilots.', user_id: User.first.id )
Course.create(course_type:'Cabin Courses', info:'General subject ground e-learning courses for cabin crews.', user_id: User.first.id )
Course.create(course_type:'Technician Courses', info:'General subject ground e-learning courses for technicians.', user_id: User.first.id )
